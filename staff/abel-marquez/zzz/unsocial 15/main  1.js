...
const red = React.createElement('li', {style : {backgroundcolor: 'red'}})

const green = React.createElement('li',{style : {backgroundcolor: 'green'}})

const blue = React.createElement('li', {style: {backgroundcolor: 'green'}})
...
class Car extends Component {
    ...
    render() {
        const content = React.createElement('span',{
            style: { padding: '2px' }}, this.props.car)
