...
export default async () => {
    try {
        ...
        if (!token) throw new SystemError('No se encontró el token en localStorage');
        ...
        if (!response.ok) {
            ...
            throw new (errors[errorData.error] || SystemError)(errorData.message || 'Error desconocido');
        }
