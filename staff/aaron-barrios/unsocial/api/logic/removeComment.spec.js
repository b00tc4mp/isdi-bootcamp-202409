...
describe('removeComment', () => {
    ...
    it('fails on not-owning comment', () => {
        const user = new User({ name: 'Coco Loco', email: 'coco@loco.com', username: 'cocoloco', password: '123123123' })

        const user2 = new User({ name: 'Coco Drilo', email: 'coco@drilo.com', username: 'cocodrilo', password: '123123123' })

        const comment = new Comment({ author: user.id, text: 'hello world' })
