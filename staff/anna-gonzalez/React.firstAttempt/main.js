...
class Car extends Component {
    ...
    render() {
        const content = React.createElement('span', { style: { padding: '2px' } }, [this.props.car, this.props.state])

        return content
    }
}

const blueCar = new Car({ car: '🚙', state: 'off' })
const redCar = new Car({ car: '🚗', state: 'on' })
const yellowCar = new Car({ car: '🚕', state: 'off' })
