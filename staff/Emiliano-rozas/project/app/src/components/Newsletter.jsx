    ...
    return (
        <div className='text-center'>
            ...
            <form onSubmit={handleSubmit} className='w-full sm:w-1/2 flex items-center gap-1 mx-auto px-10 py-4'>
                <input className='w-full sm:flex-1 bg-black focus:outline-none focus:ring-0 focus:border-green-700 caret-green-700 text-white' type="email" placeholder='Enter your email' required />
