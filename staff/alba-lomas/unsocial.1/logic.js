...
// funcion del login
function authenticateUser(username, password) { // creamos la funcion para validar todas las reglas.
    if (username.length < 4 || username.length > 12) { // regla para username
        throw new Error('invalid username')
    ...
    var user = users.find(function (user) { // regla para que el username y el password sean iguales que uno existente.
