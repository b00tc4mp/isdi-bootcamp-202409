...
describe('authenticateUser', () => {
    ...
    it('succeeds on existing user', async () => {
        await User.create({ name: 'Angel', email: 'angel@angel.com', username: 'angel', password: bcrypt.hashSync('123123123', 10) })

        const user = await authenticateUser('angel@angel.com', '123123123')
