export default function Alert({ message, level = 'error', onAccepted }) {
    ...
    return <div className="fixed h-full w-full top0 flex items-center justify-center border-radius:20px">
        <div className={`min-w-[20rem] max-w-[40rem] min-h-[10rem] bg-white ${borderColor} border-[1rem] flex flex-col items-center justify-center p-2 gap-2`}>
            ...
            <button className="border-2 border-black pt-1 border-radius:20px" onClick={handleAcceptClick}>Confirmar</button>
        </div>
    </div>
}