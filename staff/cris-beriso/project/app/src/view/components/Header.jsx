...
export default function Header({ onLoggedOut }) {
  ...
  return <header className={location.pathname === '/login' || location.pathname === '/register' ? "  h-12 box-border flex justify-between items-center fixed top-0 w-full p-2" : '  h-12 box-border flex justify-between items-center fixed top-0 w-full p-2 bg-box'}>
