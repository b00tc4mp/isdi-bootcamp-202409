...
describe('createPost', () => {
  ...
  // ESTE TEST (SIN EL FINALLY) NO ES BUENO PORQUE NO HAY NINGÚN ERROR SÍNCRONO, 
  // PERO SÍ ASINCRONO Y NO TENEMOS NADA QUE LO CAPTURE
  ...
  //     expect(expectedError.message).to.be.equal('invalid userId')
  //   }
  // })
