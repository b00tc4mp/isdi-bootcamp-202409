...
export default function Chat() {
  ...
  useEffect(() => {
    async function findChat() {
      ...
      if (response) redirect(`/users/chats/${response._id}`);
    }

    findChat();
  }, [authorId]);
  // si existe se redirige al chat existente de lo contrario se envía el mensaje, luego se redirige al chat recién creado
