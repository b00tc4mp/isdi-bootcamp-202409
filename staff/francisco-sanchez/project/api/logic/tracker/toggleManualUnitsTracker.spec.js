...
describe('toggle Manual Units Tracker', () => {
    ...
    it('succeeds on add manual units', async () => {
        ...
        const updatedPack = await toggleManualUnitsTracker(newUserProvider._id.toString(), checkpackAssigned._id.toString(), newUserCustomer._id.toString(), 'añado 1u al pack', 1)
        expect(updatedPack.remainingQuantity).to.equal(6)
        ...
        expect(packs[1].description).to.equal('añado 1u al pack')
        expect(packs[1].operation).to.equal('add')
        expect(packs[1].remainingQuantity).to.equal(6)
    })

    it('succeeds on substract manual units', async () => {
        const newUserProvider = await User.create({ username: 'ristoProvider', password: 'risto123', email: 'ristop@risto.com' })
        const newUserCustomer = await User.create({ username: 'ristoCustomer', password: 'risto123', email: 'ristoc@risto.com' })
        ...
        const updatedPack = await toggleManualUnitsTracker(newUserProvider._id.toString(), checkpackAssigned._id.toString(), newUserCustomer._id.toString(), 'quito 1u al pack', -1)
        expect(updatedPack.remainingQuantity).to.equal(4)
        expect(updatedPack.originalQuantity).to.equal(5)
        ...
        expect(packs[1].description).to.equal('quito 1u al pack')
        expect(packs[1].operation).to.equal('substract')
        expect(packs[1].remainingQuantity).to.equal(4)
    })


    it('succeeds on substract manual units and no description added', async () => {
        const newUserProvider = await User.create({ username: 'ristoProvider', password: 'risto123', email: 'ristop@risto.com' })
        const newUserCustomer = await User.create({ username: 'ristoCustomer', password: 'risto123', email: 'ristoc@risto.com' })
        ...
        const updatedPack = await toggleManualUnitsTracker(newUserProvider._id.toString(), checkpackAssigned._id.toString(), newUserCustomer._id.toString(), '', -1)
        expect(updatedPack.remainingQuantity).to.equal(4)
        expect(updatedPack.originalQuantity).to.equal(5)
    ...
    it('fails on non existing userId', () =>
        expect((async () => {
            ...
            await toggleManualUnitsTracker('678640d38e72f4f81f327b89', checkpackAssigned._id.toString(), newUserCustomer._id.toString(), 'quito 1u al pack', -1)
            /***************************************** */
    ...
    it('fails on invalid userId', () =>
        expect((async () => {
            ...
            await toggleManualUnitsTracker(123456, checkpackAssigned._id.toString(), newUserCustomer._id.toString(), 'quito 1u al pack', -1)
            /***************************************** */
    ...
    it('fails on pack not found', () =>
        expect((async () => {
            ...
            await toggleManualUnitsTracker(newUserProvider._id.toString(), '6799511d29bbdc2f01504004', newUserCustomer._id.toString(), 'quito 1u al pack', -1)
            /***************************************** */
    ...
    it('fails on invalid packId', () =>
        expect((async () => {
            ...
            await toggleManualUnitsTracker(newUserProvider._id.toString(), 123456, newUserCustomer._id.toString(), 'quito 1u al pack', -1)
            /***************************************** */
    ...
    it('fails on invalid customerId', () =>
        expect((async () => {
            ...
            await toggleManualUnitsTracker(newUserProvider._id.toString(), checkpackAssigned._id.toString(), 123456, 'quito 1u al pack', -1)
            /***************************************** */
    ...
    it('fails on invalid pack status', () =>
        expect((async () => {
            ...
            await toggleManualUnitsTracker(newUserProvider._id.toString(), checkpackAssigned._id.toString(), checkpackAssigned._id.toString(), 'quito 1u al pack', -1)
            /***************************************** */
