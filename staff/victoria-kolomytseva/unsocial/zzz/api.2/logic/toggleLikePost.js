import { validate } from './helpers/index.js'//Se traen funciones para validar los datos y el objeto storage, que contiene las publicaciones
...
export default (userId, postId,) => { //Esta función toma dos argumentos: postId (el ID de la publicación) y userId (el ID del usuario)
    ...
    const found = users.come(({ id }) => id === userId)
