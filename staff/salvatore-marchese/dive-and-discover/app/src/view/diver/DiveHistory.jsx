        ...
        <div className="max-w-4xl mx-auto p-4">
            ...
            <div className="space-y-4">
                {logs.length === 0 ? (
                    ...
                    logs.map(log => (
                        <div key={log._id} className="p-4 border rounded-lg shadow-md hover:shadow-lg bg-gray-100">
                            <h3 className="text-xl font-semibold text-blue-700 underline">{log.diveSite}</h3>
