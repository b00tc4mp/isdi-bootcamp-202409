var reverse = function (iterable) {
    if (iterable.length === 2) {
        ...
        // iterable -> { 0: 'Peter', 1: 'John', 2: 'Annita', 3: 'Mary', 4: 'Oswald', length: 5 }

        // element -> Oswald (iterable[4])
        // iterable[4] = iterable[0] (iterable -> { 0: 'Peter', 1: 'John', 2: 'Annita', 3: 'Mary', 4: 'Peter', length: 5 })
        // iterable[0] = element (iterable -> { 0: 'Oswald', 1: 'John', 2: 'Annita', 3: 'Mary', 4: 'Peter', length: 5 })

        // element -> Mary (iterable[3])
        // iterable[3] = iterable[1] (iterable -> { 0: 'Oswald', 1: 'John', 2: 'Annita', 3: 'John', 4: 'Peter', length: 5 })
        // iterable[1] = element (iterable -> { 0: 'Oswald', 1: 'Mary', 2: 'Annita', 3: 'John', 4: 'Peter', length: 5 })
