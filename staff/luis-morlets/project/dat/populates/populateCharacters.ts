...
import { Character, Skill, Stats } from '../models/index.js'
...
db.connect(process.env.MONGO_URL_TEST!)
    ...
    .then(() => Promise.all([
        Character.create({
            ...
            items: [new ObjectId('674fabc309c47e901f27d0ed'), new ObjectId('674fabc309c47e901f27d0ec')]
        }),
        Character.create({
        ...
        Character.create({
            ...
            class: 'Paladin',
            race: 'Human',
            statistics: new Stats({ armorClass: 18, hitPoints: 13, strength: 16, dexterity: 10, constitution: 14, intelligence: 10, wisdom: 13, charisma: 16 }),
            skills: [new Skill({ name: 'Divine Smite', description: 'When you hit a creature with a melee weapon attack, you can expend one spell slot to deal radiant damage.', levelRequirement: 1 }), new Skill({ name: 'Lay on Hands', description: 'Touch a creature and restore a number of hit points equal to your Paladin level.', levelRequirement: 1 }), new Skill({ name: 'Shield of Faith', description: 'Create a shimmering field granting a +2 bonus to AC.', levelRequirement: 2 }), new Skill({ name: 'Holy Wrath', description: 'Unleash a burst of holy energy, dealing radiant damage to all nearby enemies.', levelRequirement: 3 })],
            items: [new ObjectId('674fabc309c47e901f27d0ed'), new ObjectId('674fabc309c47e901f27d0ec'), new ObjectId('674fabc309c47e901f27d0ef')]
        }),
        Character.create({
        ...
        Character.create({
            ...
            class: 'Cleric',
            race: 'Dwarf',
            statistics: new Stats({ armorClass: 16, hitPoints: 12, strength: 12, dexterity: 10, constitution: 14, intelligence: 10, wisdom: 18, charisma: 12 }),
            skills: [new Skill({ name: 'Sacred Flame', description: 'Call down holy fire to damage an enemy.', levelRequirement: 1 }), new Skill({ name: 'Healing Word', description: 'Heal a wounded ally from a distance.', levelRequirement: 1 }), new Skill({ name: 'Blessing', description: 'Bless nearby allies, increasing their attack rolls.', levelRequirement: 2 }), new Skill({ name: 'Divine Sanctuary', description: 'Create a zone of protection that heals allies.', levelRequirement: 3 })],
            items: [new ObjectId('674fabc309c47e901f27d0ed'), new ObjectId('674fabc309c47e901f27d0ec'), new ObjectId('674fabc309c47e901f27d0ef')]
        }),
        Character.create({
            ...
            class: 'Mage',
            race: 'Elf',
            statistics: new Stats({ armorClass: 12, hitPoints: 8, strength: 8, dexterity: 14, constitution: 12, intelligence: 18, wisdom: 14, charisma: 10 }),
            skills: [new Skill({ name: 'Magic Missile', description: 'Launch a magical projectile that never misses its target.', levelRequirement: 1 }), new Skill({ name: 'Arcane Shield', description: 'Create a magical shield that absorbs incoming damage.', levelRequirement: 1 }), new Skill({ name: 'Fireball', description: 'Hurl a fiery explosion that deals massive area damage.', levelRequirement: 2 }), new Skill({ name: 'Ice Storm', description: 'A hail of rock-hard ice pounds the ground to deal damage to enemies in area.', levelRequirement: 3 })],
            items: [new ObjectId('674fabc309c47e901f27d0ed'), new ObjectId('674fabc309c47e901f27d0ec'), new ObjectId('674fabc309c47e901f27d0ef')]
        })
    ]))
    .catch(console.error)
