...
db.connect(process.env.MONGO_URL!)
    ...
    .then(() => Promise.all([
        Character.create({
            ...
            items: [new ObjectId('675fe2b96e02ab061742049e'), new ObjectId('675fe2b96e02ab061742049e')]
        }),
        Character.create({
        ...
        Character.create({
            ...
            currency: new Currency({ name: 'Gold Coin', quantity: 50 }),
            items: [new ObjectId('675fe2b96e02ab061742049e'), new ObjectId('675fe2b96e02ab06174204a0')]
        }),
        Character.create({
        ...
        Character.create({
            ...
            currency: new Currency({ name: 'Gold Coin', quantity: 50 }),
            items: [new ObjectId('675fe2b96e02ab06174204a0'), new ObjectId('675fe2b96e02ab061742049e')]
        }),
        Character.create({
