...
describe('getPosts', () => {
    ...
    it('succeeds on existing user', () => {
        ...
        const post2 = new Post({ author: user.id, image: 'https://www.image.com/2', text: 'hello world again', date: new Date(2024, 10, 19) })
    ...
    it('fails on non-existing user', () =>
        expect(
            getPosts('012345678901234567890123', '012345678901234567890123')
