...
describe('getPosts', () => {
    ...
    it('...', () => {
        ...
        //expect(() => authenticate('pepito', '123123123_')).to.throw(Error, 'wrong credentials')

        //return expect(authenticateAsync('pepito', '123123123')).to.eventually.equal('abc123')
        return expect(authenticateAsync('pepito', '123123123_')).to.be.rejectedWith(Error, /^wrong credentials$/)
    })
})
